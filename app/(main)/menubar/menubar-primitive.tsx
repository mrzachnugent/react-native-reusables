        ...
        >
            ...
            <Menubar.Portal hostName={portalHost}>
              ...
              >
                <Menubar.Group>
                  ...
                  <Menubar.Item onPress={closeAllSubMenus}>
                    <Text className='text-foreground text-xl'>New File...</Text>
                  </Menubar.Item>
                  <Menubar.Item onPress={closeAllSubMenus}>
                    <Text className='text-foreground text-xl'>New Window</Text>
                  </Menubar.Item>
                </Menubar.Group>
                <Menubar.Separator />
                <Menubar.Group>
          ...
          <Menubar.Menu value='terminal' className=' bg-background'>
            ...
            <Menubar.Portal hostName={portalHost}>
              ...
              >
                <Menubar.Item onPress={closeAllSubMenus}>
                  <Text className='text-foreground text-xl'>New Terminal</Text>
                </Menubar.Item>
              </Menubar.Content>
            </Menubar.Portal>
          </Menubar.Menu>
