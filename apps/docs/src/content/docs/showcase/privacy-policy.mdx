...
The React Native Reusables Showcase App (“the App”) is a demonstration application created to showcase UI components and blocks provided by the React Native Reusables project. Your privacy is important to us. This Privacy Policy explains what information we collect, how we use it, and your rights regarding that information.
