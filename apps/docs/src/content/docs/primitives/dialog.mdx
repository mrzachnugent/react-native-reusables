...
import importedNativeCode from '@/../node_modules/@rnr/dialog/src/dialog-native.tsx?raw';
...
<Code title="~/components/primitives/dialog/dialog-native.tsx" code={importedNativeCode} />
