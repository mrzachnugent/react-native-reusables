...
<Tabs>
  ...
  <TabItem label='Manual'>
    <Aside type='tip' title='Dependencies'>
      Before copy/pasting, add the <a href='/primitives/navigation-menu' className='text-white font-bold'> navigation-menu primitive</a> to your project.
    </Aside>
...
```tsx
import type { TextRef } from '~/components/primitives/types';
