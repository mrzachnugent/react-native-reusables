...
<Aside type='tip' title='Dependencies'>
  Before copy/pasting, add the <a href='/primitives/context-menu' className='text-white font-bold'> context-menu primitive</a> and the <a href='/components/text' className='text-white font-bold'>text component</a> to your project.
</Aside>
