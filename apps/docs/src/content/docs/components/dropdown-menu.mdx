...
<LinkButton href='/primitives/dropdown-menu'>Dropdown Menu Primitive</LinkButton>
...
<Tabs>
  ...
  <TabItem label='Manual'>
    <Aside type='tip' title='Dependencies'>
      Before copy/pasting, add the <a href='/primitives/dropdown-menu' className='text-white font-bold'> dropdown-menu primitive</a> and the <a href='/components/text' className='text-white font-bold'>text component</a> to your project.
    </Aside>
