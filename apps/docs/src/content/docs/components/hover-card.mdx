...
<LinkButton href='/primitives/hover-card'>Hover Card Primitive</LinkButton>
...
<Aside type='tip' title='Dependencies'>
  Before copy/pasting, add the <a href='/primitives/hover-card' className='text-white font-bold'> hover-card primitive</a> to your project.
</Aside>
