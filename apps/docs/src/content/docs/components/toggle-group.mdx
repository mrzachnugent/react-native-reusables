...
<LinkButton href='/primitives/toggle-group'>Toggle Group Primitive</LinkButton>
...
<Tabs>
  ...
  <TabItem label='Manual'>
    <Aside type='tip' title='Dependencies'>
      Before copy/pasting, add the <a href='/primitives/toggle-group' className='text-white font-bold'>toggle group primitive</a> and the <a href='/components/text' className='text-white font-bold'>text component</a> to your project.
    </Aside>
