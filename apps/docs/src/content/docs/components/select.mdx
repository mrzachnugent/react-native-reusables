...
<LinkButton href='/primitives/select'>Select Primitive</LinkButton>
...
<Aside type='tip' title='Dependencies'>
  Before copy/pasting, add the <a href='/primitives/select' className='text-white font-bold'> select primitive</a> to your project.
</Aside>
