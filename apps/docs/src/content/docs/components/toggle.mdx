...
<LinkButton href='/primitives/toggle'>Toggle Primitive</LinkButton>
...
<Tabs>
  ...
  <TabItem label='Manual'>
    <Aside type='tip' title='Dependencies'>
      Before copy/pasting, add the <a href='/primitives/toggle' className='text-white font-bold'>toggle primitive</a> and the <a href='/components/text' className='text-white font-bold'>text component</a> to your project.
    </Aside>
