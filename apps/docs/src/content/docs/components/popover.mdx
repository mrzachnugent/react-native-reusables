...
<Tabs>
  ...
  <TabItem label='Manual'>
    <Aside type='tip' title='Dependencies'>
      Before copy/pasting, add the <a href='/primitives/popover' className='text-white font-bold'> popover primitive</a> and the <a href='/components/text' className='text-white font-bold'>text component</a> to your project.
    </Aside>
