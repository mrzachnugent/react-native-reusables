...
<LinkButton href='/primitives/tabs'>Tabs Primitive</LinkButton>
...
<Aside type='tip' title='Dependencies'>
  Before copy/pasting, add the <a href='/primitives/tabs' className='text-white font-bold'> tabs primitive</a> and the <a href='/components/text' className='text-white font-bold'>text component</a> to your project.
</Aside>
