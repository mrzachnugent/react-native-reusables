...
<Tabs>
  ...
  <TabItem label='Manual'>
    <Aside type='tip' title='Dependencies'>
      Before copy/pasting, add the <a href='/primitives/menubar' className='text-white font-bold'> menubar primitive</a> and the <a href='/components/text' className='text-white font-bold'>text component</a> to your project.
    </Aside>
