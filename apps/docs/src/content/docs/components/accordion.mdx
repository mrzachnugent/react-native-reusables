...
<Aside type="tip" title="Dependencies">
    Before copy/pasting, add the <a href="/primitives/accordion" className='text-white font-bold'>accordion primitive</a> and the <a href="/components/text" className='text-white font-bold'>text component</a> to your project.
</Aside>
