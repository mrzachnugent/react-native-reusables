...
<div className="bg-card flex flex-col-reverse items-center justify-between gap-6 sm:gap-8 rounded-xl border p-12 shadow-sm lg:flex-row lg:p-14 not-prose my-12">
  <div className="flex max-w-[25.5rem] flex-col items-center justify-center gap-8 lg:items-start">
    <div>
