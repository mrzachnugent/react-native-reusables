...
<AuthBlockTabs>
  ...
  <AuthBlockTabsCliContent integration="clerk">
    <Steps>
      <Step>
        <CommandTabs args={["add", "clerk-reset-password-form"]}/>
      </Step>
      <Step>
      ...
      <Step>
        **All set!**
        ...
        You can import `ClerkResetPasswordForm` in your app.

        ```tsx
        import { ClerkResetPasswordForm } from '@/components/clerk-reset-password-form';
        import { ScrollView, View } from 'react-native';
