...
<AuthBlockTabs>
  ...
  <AuthBlockTabsCliContent integration="clerk">
    <Steps>
      <Step>
        <CommandTabs args={["add", "clerk-forgot-password-form"]}/>
      </Step>
      <Step>
      ...
      <Step>
        **All set!**
        ...
        You can import `ClerkForgotPasswordForm` in your app.

        ```tsx
        import { ClerkForgotPasswordForm } from '@/components/clerk-forgot-password-form';
        import { ScrollView, View } from 'react-native';
