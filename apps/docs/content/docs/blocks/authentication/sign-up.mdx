...
import { SignUp } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full max-w-sm"><SignUp /></div>} />
...
<AuthBlockTabs>
  <AuthBlockTabsCliContent integration="none">
    <Steps>
      <Step>
        <CommandTabs args={["add", "sign-up"]}/>
      </Step>
      <Step>
        **All set!**

        You can now use the `SignUp` block in your app.
      </Step>
    </Steps>
  ...
  <AuthBlockTabsCliContent integration="clerk">
    <Steps>
      <Step>
        <CommandTabs args={["add", "clerk-sign-up"]}/>
      </Step>
      <Step>
      ...
      <Step>
        **All set!**
        ...
        You can use the `ClerkSignUp` block in your app.
      </Step>
    </Steps>
  </AuthBlockTabsCliContent>
