...
<AuthBlockTabs>
  ...
  <AuthBlockTabsCliContent integration="clerk">
    <Steps>
      <Step>
        <CommandTabs args={["add", "clerk-verify-email-form"]}/>
      </Step>
      <Step>
      ...
      <Step>
        **All set!**
        ...
        You can import `ClerkVerifyEmailForm` in your app.

        ```tsx
        import { ClerkVerifyEmailForm } from '@/components/clerk-verify-email-form';
        import { ScrollView, View } from 'react-native';
