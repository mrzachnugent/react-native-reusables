...
import { ResetPassword } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full max-w-sm"><ResetPassword /></div>} />
...
<AuthBlockTabs>
  <AuthBlockTabsCliContent integration="none">
    <Steps>
      <Step>
        <CommandTabs args={["add", "reset-password"]}/>
      </Step>
      <Step>
        **All set!**

        You can now use the `ResetPassword` block in your app.
      </Step>
    </Steps>
  ...
  <AuthBlockTabsCliContent integration="clerk">
    <Steps>
      <Step>
        <CommandTabs args={["add", "clerk-reset-password"]}/>
      </Step>
      <Step>
      ...
      <Step>
        **All set!**
        ...
        You can use the `ClerkResetPassword` block in your app.
      </Step>
    </Steps>
  </AuthBlockTabsCliContent>
