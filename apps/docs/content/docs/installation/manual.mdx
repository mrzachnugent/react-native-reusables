...
<InstallationTabs value="manual">
  ...
  <Steps>
    ...
    <Step>
      ### Add the Portal to your root layout
      Render the `Portal` from `@rn-primitives/portal` in your root layout. Place it as the last child of your providers. This is where your components that use the `PortalHost` will be rendered (e.g. `DropdownMenu`, `Tooltip`, `Popover`, etc.).
    ...
    <Step>
      ...
      <div className='text-fd-muted-foreground'>
        For more details, see the [Customization](/docs/customization#theming) page.
      </div>
