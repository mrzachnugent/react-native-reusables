...
<SectionTabs defaultValue="preview">
  ...
  <SectionTabsContent value="preview">
    ...
    <PreviewCard copyContent={accordionPreview} webPreview={<AccordionPreview />} webNewYorkPreview={<AccordionNewYorkPreview />} />
  </SectionTabsContent>
  <SectionTabsContent value="code">
    <ShowIfStyle style="default">
    ```json doc-gen:file
    {
      "file": "./node_modules/@rnr/registry/src/default/examples/accordion.tsx",
      "codeblock": {
        "lang": "tsx"
      }
    } 
