...
function Textarea({
  ...
  return (
    <TextInput
      className={cn(
        'text-foreground border-input dark:bg-input/30 flex min-h-[80px] w-full flex-row rounded-md border bg-transparent px-3 py-2 text-base shadow-sm md:text-sm',
        Platform.select({
